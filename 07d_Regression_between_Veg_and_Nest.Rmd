...
```
```{r betareg}
summary(fullmod_survival<-betareg(survival~alt_tall_pct+alt_tall_pres+distichlis_pct+distichlis_pres+gerardii_pct+gerardii_pres+patens_pct+patens_pres+alt_short_pct+alt_short_pres+phrag_pct+phrag_pres+low_marsh_pct+low_marsh_pres+high_marsh_pct+high_marsh_pres+brackish_border_pct+brackish_border_pres+saltmarsh_border_pct+saltmarsh_border_pres+`non-saltmarsh_pct`+`non-saltmarsh_pres`+trees_pct+trees_pres+iva_pct+iva_pres+Lat,data=rapid_dat10.model))

summary(fullmod_survival_pct<-betareg(survival~alt_tall_pct+distichlis_pct+gerardii_pct+patens_pct+alt_short_pct+phrag_pct+low_marsh_pct+high_marsh_pct+brackish_border_pct+saltmarsh_border_pct+trees_pct+iva_pct+upland_pct+water_pct+Lat,data=rapid_dat10.model))

summary(fullmod_survival_pres<-betareg(survival~alt_tall_pres+distichlis_pres+gerardii_pres+patens_pres+alt_short_pres+phrag_pres+low_marsh_pres+high_marsh_pres+brackish_border_pres+saltmarsh_border_pres+`non-saltmarsh_pres`+trees_pres+iva_pres+Lat,data=rapid_dat10.model))

stepmod_survival<-StepBeta(fullmod_survival,k=2)
stepmod_survival_pct<-StepBeta(fullmod_survival_pct,k=2)
stepmod_survival_pres<-StepBeta(fullmod_survival_pres,k=2)
simplified_surv_pct<-betareg(survival ~ alt_tall_pct+ distichlis_pct+gerardii_pct +patens_pct + alt_short_pct+ phrag_pct +low_marsh_pct+ high_marsh_pct + brackish_border_pct + saltmarsh_border_pct + upland_pct + water_pct + Lat, data = rapid_dat10.model )

```
```{r betareg presence}
summary(fullmod_pres<-betareg(presence~alt_tall_pct+alt_tall_pres+distichlis_pct+distichlis_pres+gerardii_pct+gerardii_pres+patens_pct+patens_pres+alt_short_pct+alt_short_pres+phrag_pct+phrag_pres+low_marsh_pct+low_marsh_pres+high_marsh_pct+high_marsh_pres+brackish_border_pct+brackish_border_pres+saltmarsh_border_pct+saltmarsh_border_pres+`non-saltmarsh_pct`+`non-saltmarsh_pres`+trees_pct+trees_pres+iva_pct+iva_pres+Lat,data=rapid_dat10.model))

summary(fullmod_pres_pct<-betareg(presence~alt_tall_pct+distichlis_pct+gerardii_pct+patens_pct+alt_short_pct+phrag_pct+low_marsh_pct+high_marsh_pct+brackish_border_pct+saltmarsh_border_pct+trees_pct+iva_pct+upland_pct+water_pct+Lat,data=rapid_dat10.model))

summary(fullmod_pres_pres<-betareg(presence~alt_tall_pres+distichlis_pres+gerardii_pres+patens_pres+alt_short_pres+phrag_pres+low_marsh_pres+high_marsh_pres+brackish_border_pres+saltmarsh_border_pres+`non-saltmarsh_pres`+trees_pres+iva_pres+Lat,data=rapid_dat10.model))
stepmod_pres<-StepBeta(fullmod_pres,k=2)
stepmod_pres_pct<-StepBeta(fullmod_pres_pct,k=2)
stepmod_pres_pres<-StepBeta(fullmod_pres_pres,k=2)
simplified_pres_pct<-betareg(formula =  presence ~  alt_tall_pct+distichlis_pct + gerardii_pct+patens_pct + alt_short_pct +phrag_pct  + high_marsh_pct + brackish_border_pct + trees_pct + upland_pct + Lat,data = rapid_dat10.model)
```
```{r }
...
#alt_tall
mod_list_pres1[[1]]<-betareg(presence~alt_tall_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_pres1[[2]]<-betareg(presence~alt_tall_pct+Lat, 
                          data=rapid_dat10.model
                          )
#distichlis
mod_list_pres1[[3]]<-betareg(presence~distichlis_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_pres1[[4]]<-betareg(presence~distichlis_pct+Lat, 
                         data=rapid_dat10.model
                         )
#gerardii
mod_list_pres1[[5]]<-betareg(presence~gerardii_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_pres1[[6]]<-betareg(presence~gerardii_pct+Lat, 
                         data=rapid_dat10.model
                         )
#patens
mod_list_pres1[[7]]<-betareg(presence~patens_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_pres1[[8]]<-betareg(presence~patens_pct+Lat, 
                         data=rapid_dat10.model
)
#alt_short
mod_list_pres1[[9]]<-betareg(presence~alt_short_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_pres1[[10]]<-betareg(presence~alt_short_pct+Lat, 
                         data=rapid_dat10.model
                         )
#phrag
mod_list_pres1[[11]]<-betareg(presence~phrag_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[12]]<-betareg(presence~phrag_pct+Lat,
                          data=rapid_dat10.model
                          )
#HIGHMARSH
mod_list_pres1[[13]]<-betareg(presence~high_marsh_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[14]]<-betareg(presence~high_marsh_pct+Lat, 
                          data=rapid_dat10.model
                          )
#Barckish Border
mod_list_pres1[[15]]<-betareg(presence~brackish_border_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[16]]<-betareg(presence~brackish_border_pct+Lat, 
                          data=rapid_dat10.model
                          )
#Non-saltmarsh

mod_list_pres1[[17]]<-betareg(presence~upland_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[18]]<-betareg(presence~upland_pct+Lat, 
                          data=rapid_dat10.model
                          )
#Tree
mod_list_pres1[[19]]<-betareg(presence~trees_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[20]]<-betareg(presence~trees_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[21]]<-betareg(presence~iva_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[22]]<-betareg(presence~iva_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[23]]<-betareg(presence~low_marsh_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[24]]<-betareg(presence~low_marsh_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[25]]<-betareg(presence~saltmarsh_border_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[26]]<-betareg(presence~saltmarsh_border_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[27]]<-betareg(presence~water_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[28]]<-betareg(presence~water_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_pres1[[29]]<- simplified_pres_pct
mod_list_pres1[[30]]<- fullmod_pres_pct
...
# How much variation does each variable explain relative to each other?
#alt_tall
mod_list_surv1[[1]]<-betareg(survival~alt_tall_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_surv1[[2]]<-betareg(survival~alt_tall_pct+Lat, 
                          data=rapid_dat10.model
                          )
#distichlis
mod_list_surv1[[3]]<-betareg(survival~distichlis_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_surv1[[4]]<-betareg(survival~distichlis_pct+Lat, 
                         data=rapid_dat10.model
                         )
#gerardii
mod_list_surv1[[5]]<-betareg(survival~gerardii_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_surv1[[6]]<-betareg(survival~gerardii_pct+Lat, 
                         data=rapid_dat10.model
                         )
#patens
mod_list_surv1[[7]]<-betareg(survival~patens_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_surv1[[8]]<-betareg(survival~patens_pct+Lat, 
                         data=rapid_dat10.model
)
#alt_short
mod_list_surv1[[9]]<-betareg(survival~alt_short_pres+Lat, 
                         data=rapid_dat10.model
                         )
mod_list_surv1[[10]]<-betareg(survival~alt_short_pct+Lat, 
                         data=rapid_dat10.model
                         )
#phrag
mod_list_surv1[[11]]<-betareg(survival~phrag_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[12]]<-betareg(survival~phrag_pct+Lat,
                          data=rapid_dat10.model
                          )
#HIGHMARSH
mod_list_surv1[[13]]<-betareg(survival~high_marsh_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[14]]<-betareg(survival~high_marsh_pct+Lat, 
                          data=rapid_dat10.model
                          )
#Barckish Border
mod_list_surv1[[15]]<-betareg(survival~brackish_border_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[16]]<-betareg(survival~brackish_border_pct+Lat, 
                          data=rapid_dat10.model
                          )
#Non-saltmarsh

mod_list_surv1[[17]]<-betareg(survival~upland_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[18]]<-betareg(survival~upland_pct+Lat, 
                          data=rapid_dat10.model
                          )
#Tree
mod_list_surv1[[19]]<-betareg(survival~trees_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[20]]<-betareg(survival~trees_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[21]]<-betareg(survival~iva_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[22]]<-betareg(survival~iva_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[23]]<-betareg(survival~low_marsh_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[24]]<-betareg(survival~low_marsh_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[25]]<-betareg(survival~saltmarsh_border_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[26]]<-betareg(survival~saltmarsh_border_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[27]]<-betareg(survival~water_pres+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[28]]<-betareg(survival~water_pct+Lat, 
                          data=rapid_dat10.model
                          )
mod_list_surv1[[29]]<- simplified_surv_pct
mod_list_surv1[[30]]<- fullmod_survival_pct
# store model selection factors in a table
...
mod_tab_habstr[23,"Model_Name"]<-"low marsh pres/abs"
mod_tab_habstr[23,"Function"]<-deparse1(mod_list_surv1[[23]]$formula)
...
mod_tab_habstr[30,"Model_Name"]<-"full model"
mod_tab_habstr[30,"Function"]<-deparse1(mod_list_surv1[[30]]$formula)
mod_tab_habstr[30,"AIC"]<-AIC(mod_list_surv1[[30]])
